...
im1_original = imread('images/image1.jpg');
%% saltpepper
figure(1)
...
%%  PSNR 
disp('image 1')
psnr_box3_im1 = myPSNR(im1_original,denoised_box_3)
psnr_box5_im1 = myPSNR(im1_original,denoised_box_5)
psnr_box7_im1 = myPSNR(im1_original,denoised_box_7)
psnr_median3_im1 = myPSNR(im1_original,denoised_median_3)
psnr_median5_im1 = myPSNR(im1_original,denoised_median_5)
psnr_median7_im1 = myPSNR(im1_original,denoised_median_7)
%% gaussian
figure(2)
...
%%
disp('image2')
psnr_box3_im2 = myPSNR(im1_original,denoised_box_3)
psnr_box5_im2 = myPSNR(im1_original,denoised_box_5)
psnr_box7_im2 = myPSNR(im1_original,denoised_box_7)
psnr_median3_im2 = myPSNR(im1_original,denoised_median_3)
psnr_median5_im2 = myPSNR(im1_original,denoised_median_5)
psnr_median7_im2 = myPSNR(im1_original,denoised_median_7)
